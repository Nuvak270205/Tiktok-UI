export const UploadIcon = ({ width = '42px', height = '38px', className }) => {
    return (
        <svg
            className={className}
            fill="currentColor"
...
export const FlashIcon = ({ width = '42px', height = '38px', className }) => {
    return (
        <svg
            fill="currentColor"
            className={className}
...
export const MessageIcon = ({ width = '52px', height = '44px', className }) => {
    return (
        <svg
            width={width}
            height={height}
